...
class PersonaController extends Controller
{
    ...
    /*Dinero*/
    public function enviarDinero($precio, $id){
        //$resultado = $precio.','.$id;
        //return $resultado;
        ...
        $redirectUrls->setReturnUrl(url("comprado/".$id))->setCancelUrl(url("/"));
    ...
    public function compra($id){
        return "La compra del usuario #".$id ." se ha completado con exito";
    }
